...
--Test some data and get the predictions
...
Xt = X:t():clone()
-- Predict the least square solution theta = (!X*X)^-1*!X*y
thetaTest = Xt*X
thetaTest = torch.inverse(thetaTest)
thetaTest = thetaTest*Xt
thetaTest = thetaTest*y
